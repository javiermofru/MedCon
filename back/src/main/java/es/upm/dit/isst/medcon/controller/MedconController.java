...
public class MedconController {
    ...
    public MedconController(CitaRepository c, PacienteRepository p, MedicoRepository m) {
        ...
        p.save(new Paciente("12345678A","Carlos Chinchilla", "30/3/1985", "Hombre","Autismo"));
        p.save(new Paciente("87654321A","Cira Pozo", "12/8/1994", "Mujer", "Cáncer"));
        p.save(new Paciente("12345678B","Javier Moreno", "26/07/2000", "Hombre", "Déficit de atención e hiperactividad"));
